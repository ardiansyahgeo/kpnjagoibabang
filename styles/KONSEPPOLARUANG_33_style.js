var size = 0;
var placement = 'point';
function categories_KONSEPPOLARUANG_33(feature, value, size, resolution, labelText,
...
case 'Ruang Terbuka Non Hijau':
                    return [ new ol.style.Style({
        fill: new ol.style.Fill({color: 'rgba(0,105,105,0.8)'}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
var style_KONSEPPOLARUANG_33 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_KONSEPPOLARUANG_33(feature, value, size, resolution, labelText,
