var size = 0;
var placement = 'point';
function categories_JaringanTransportasi_4(feature, value, size, resolution, labelText,
...
case 'Jalan Lingkungan Primer':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(23,99,221,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 0.988}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
var style_JaringanTransportasi_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_JaringanTransportasi_4(feature, value, size, resolution, labelText,
