var size = 0;
var placement = 'point';
function categories_POLARUANGRDTR2019_3(feature, value, size, resolution, labelText,
...
case 'Sentra Industri Kecil dan Menengah':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(35,35,35,0.8)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.988}),fill: new ol.style.Fill({color: 'rgba(97,180,205,0.8)'}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
var style_POLARUANGRDTR2019_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_POLARUANGRDTR2019_3(feature, value, size, resolution, labelText,
